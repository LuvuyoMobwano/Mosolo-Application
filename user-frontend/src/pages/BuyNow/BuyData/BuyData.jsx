...
const BuyData = () => {
  ...
  return (
    <div>
      ...
      >
        <h1 style={styles.styleHeading}>Buy Cellular Data</h1>
        ...
        <button className="stylePurchaseButton" style={styles.stylePurchaseButton} onClick={handleBuyData}>
          Purchase
        </button>
      </div>
    </div>
